...
export class Player extends Character {
    ...
    goombaCollision() {
        if (this.timer === false) {
            ...
            if (GameEnv.difficulty === "normal" || GameEnv.difficulty === "hard") {
                ...
                if (GameEnv.currentLevel.tag == "secret fear level") {
                    mageDeath();
    ...
    update() {
        ...
        if (this.isActiveAnimation("a")) {
            ...
            //flip shaun to correct spritesheet            
            if (GameEnv.currentLevel.tag == "secret fear level") {this.canvas.style.transform = "scaleX(-1)";}
        }
        // Player moving left
        if (this.isActiveAnimation("d")) {
            ...
            //flip shaun to correct spritesheet
            if (GameEnv.currentLevel.tag == "secret fear level") {this.canvas.style.transform = "";}
        }
        ...
        //Prevent Player from Dashing Through diploma
    ...
    collisionAction() {
        ...
        // diploma collision check
        if (this.collisionData.touchPoints.other.id === "diploma") {
            // Collision with the left side of the diploma
            if (this.collisionData.touchPoints.other.left) {
                this.x = this.collisionData.touchPoints.other.x;
                portalSound();
