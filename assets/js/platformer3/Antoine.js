import Character from '../platformer3/Character.js';
import GameEnv from '../platformer3/GameEnv.js';
// import playGoombaDeath from '../platformer3/Audio.js';
import GameControl from '../platformer3/GameControl.js';

export class Antoine extends Character {
    ...
    constructor(canvas, image, data, xPercentage, yPercentage, name, minPosition){
        ...
        //Initial Position of Antoine
        this.x = xPercentage * GameEnv.innerWidth;

        //Access in which an Antoine can travel    
    ...
    update() {
        ...
        switch(GameEnv.difficulty) {
         ...
         //Chance for Antoine to turn Gold
    ...
    collisionAction() {
        ...
        if (this.collisionData.touchPoints.other.id === "player") {
            // Collision: Top of Antoine with Bottom of Player
            ...
            if (this.collisionData.touchPoints.other.bottom && this.immune == 0) {
                ...
                this.canvas.style.transform = "scaleY(0)"; // Make the Antoine flat
                this.speed = 0;
                playGoombaDeath();
